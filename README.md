...
-----------------------------------
  ...
  3，提供管理API动态增加微服务和删除微服务，动态加载指定目录或maven仓库中的微服务jar包
  
  4，提供统一的节点注册及服务注册的zookeeper配置中心,自动检测节点及服务状态，统一存储配置信息及分发给各节点和同步更新 
  
  5，提供微服务动态增减和热插拔(目前还没有完成)

  6，提供session功能，服务动态增减鉴权功能(白名单，黑名单)，动态增减流量控制功能，应用超时控制功能

  7，提供API文档描述和性能监控WEB页面功能
